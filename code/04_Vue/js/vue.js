...
(function (global, factory) {
   ...
   * Parse simple path.
   */
  let bailRE = new RegExp("[^".concat(unicodeRegExp.source, ".$_\\d]"));
  ...
  let initProxy;
  {
      let allowedGlobals_1 = makeMap('Infinity,undefined,NaN,isFinite,isNaN,' +
          'parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,' +
          'Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt,' +
          'require' // for Webpack/Browserify
      );
      let warnNonPresent_1 = function (target, key) {
      ...
      let warnReservedPrefix_1 = function (target, key) {
          warn$2("Property \"".concat(key, "\" must be accessed with \"$data.").concat(key, "\" because ") +
              'properties starting with "$" or "_" are not proxied in the Vue instance to ' +
              'prevent conflicts with Vue internals. ' +
              'See: https://v2.vuejs.org/v2/api/#data', target);
      };
      let hasProxy_1 = typeof Proxy !== 'undefined' && isNative(Proxy);
      if (hasProxy_1) {
          let isBuiltInModifier_1 = makeMap('stop,prevent,self,ctrl,shift,alt,meta,exact');
      ...
      let hasHandler_1 = {
          has: function (target, key) {
              ...
              let isAllowed = allowedGlobals_1(key) ||
                  (typeof key === 'string' &&
                      key.charAt(0) === '_' &&
                      !(key in target.$data));
              if (!has && !isAllowed) {
      ...
      initProxy = function initProxy(vm) {
          if (hasProxy_1) {
              ...
              let handlers = options.render && options.render._withStripped ? getHandler_1 : hasHandler_1;
  ...
  ***************************************************************************** */
  ...
  let uid$2 = 0;
  let pendingCleanupDeps = [];
  let cleanupDeps = function () {
      for (let i = 0; i < pendingCleanupDeps.length; i++) {
          let dep = pendingCleanupDeps[i];
  ...
  let Dep = /** @class */ (function () {
      ...
      Dep.prototype.notify = function (info) {
          ...
          let subs = this.subs.filter(function (s) { return s; });
          if (!config.async) {
      ...
      if (!isReadonly(target)) {
          {
              ...
              let existingOb = target && target.__ob__;
              if (existingOb && existingOb.shallow !== shallow) {
                  warn$2("Target is already a ".concat(existingOb.shallow ? "" : "non-", "shallow reactive object, and cannot be converted to ").concat(shallow ? "" : "non-", "shallow."));
              }
          }
          let ob = observe(target, shallow, isServerRendering() /* ssr mock reactivity */);
          if (!ob) {
  ...
  function toRaw(observed) {
      let raw = observed && observed["__v_raw" /* ReactiveFlags.RAW */];
  ...
  function proxyRefs(objectWithRefs) {
      ...
      let proxy = {};
      let keys = Object.keys(objectWithRefs);
      for (let i = 0; i < keys.length; i++) {
  ...
  let rawToReadonlyFlag = "__v_rawToReadonly";
  let rawToShallowReadonlyFlag = "__v_rawToShallowReadonly";
  ...
  function createReadonly(target, shallow) {
      ...
      let existingFlag = shallow ? rawToShallowReadonlyFlag : rawToReadonlyFlag;
      let existingProxy = target[existingFlag];
      if (existingProxy) {
          return existingProxy;
      }
      let proxy = Object.create(Object.getPrototypeOf(target));
  ...
  let measure;
  {
      let perf_1 = inBrowser && window.performance;
      /* istanbul ignore if */
      if (perf_1 &&
          // @ts-ignore
          perf_1.mark &&
  ...
  let normalizeEvent = cached(function (name) {
      ...
      let once = name.charAt(0) === '~'; // Prefixed last, checked first
  ...
  function extractPropsFromVNodeData(data, Ctor, tag) {
      ...
      let res = {};
      let attrs = data.attrs, props = data.props;
  ...
  function resolveSlots(children, context) {
      ...
      for (let i = 0, l = children.length; i < l; i++) {
          ...
          if ((child.context === context || child.fnContext === context) &&
              data &&
              data.slot != null) {
              let name_1 = data.slot;
              let slot = slots[name_1] || (slots[name_1] = []);
  ...
  function normalizeScopedSlots(ownerVm, scopedSlots, normalSlots, prevScopedSlots) {
      ...
      let isStable = scopedSlots ? !!scopedSlots.$stable : !hasNormalSlots;
      let key = scopedSlots && scopedSlots.$key;
      if (!scopedSlots) {
          res = {};
      }
  ...
  function initSetup(vm) {
      ...
      if (setup) {
          let ctx = (vm._setupContext = createSetupContext(vm));
          setCurrentInstance(vm);
          pushTarget();
          let setupResult = invokeWithErrorHandling(setup, null, [vm._props || shallowReactive({}), ctx], vm, "setup");
          popTarget();
          setCurrentInstance();
              ...
              if (!setupResult.__sfc) {
                  for (let key in setupResult) {
                      if (!isReserved(key)) {
                          ...
                          warn$2("Avoid using letiables that start with _ or $ in setup().");
                      }
                  }
              }
              else {
                  // exposed for compiled render fn
                  let proxy = (vm._setupProxy = {});
                  for (let key in setupResult) {
                      if (key !== '__sfc') {
  ...
  function renderMixin(Vue) {
      ...
      Vue.prototype._render = function () {
          let vm = this;
          let _a = vm.$options, render = _a.render, _parentVnode = _a._parentVnode;
  ...
  function resolveAsyncComponent(factory, baseCtor) {
      ...
      if (owner && !isDef(factory.owners)) {
          let owners_1 = (factory.owners = [owner]);
          let sync_1 = true;
          let timerLoading_1 = null;
          let timerTimeout_1 = null;
          owner.$on('hook:destroyed', function () { return remove$2(owners_1, owner); });
          let forceRender_1 = function (renderCompleted) {
          ...
          let reject_1 = once(function (reason) {
          ...
          let res_1 = factory(resolve, reject_1);
          if (isObject(res_1)) {
              if (isPromise(res_1)) {
                  // () => Promise
  ...
  function eventsMixin(Vue) {
      ...
      Vue.prototype.$emit = function (event) {
          ...
          if (cbs) {
              ...
              let info = "event handler for \"".concat(event, "\"");
  ...
  function mountComponent(vm, el, hydrating) {
      ...
      if (config.performance && mark) {
          updateComponent = function () {
              let name = vm._name;
              let id = vm._uid;
              let startTag = "vue-perf-start:".concat(id);
              let endTag = "vue-perf-end:".concat(id);
              mark(startTag);
      ...
      let preWatchers = vm._preWatchers;
      if (preWatchers) {
  ...
  function updateChildComponent(vm, propsData, listeners, parentVnode, renderChildren) {
      ...
      let hasDynamicScopedSlot = !!((newScopedSlots && !newScopedSlots.$stable) ||
      ...
      let attrs = parentVnode.data.attrs || emptyObject;
      if (vm._attrsProxy) {
      ...
      let prevListeners = vm.$options._parentListeners;
      if (vm._listenersProxy) {
  ...
  function callHook$1(vm, hook, args, setContext) {
      ...
      pushTarget();
      let prev = currentInstance;
      setContext && setCurrentInstance(vm);
      let handlers = vm.$options[hook];
      let info = "".concat(hook, " hook");
      if (handlers) {
  ...
  if (inBrowser && !isIE) {
      let performance_1 = window.performance;
      if (performance_1 &&
  ...
  let sortCompareFn = function (a, b) {
      if (a.post) {
          if (!b.post)
              return 1;
      }
  ...
  let WATCHER = "watcher";
  let WATCHER_CB = "".concat(WATCHER, " callback");
  let WATCHER_GETTER = "".concat(WATCHER, " getter");
  let WATCHER_CLEANUP = "".concat(WATCHER, " cleanup");
  // Simple effect.
  ...
  function doWatch(source, cb, _a) {
      let _b = _a === void 0 ? emptyObject : _a, immediate = _b.immediate, deep = _b.deep, _c = _b.flush, flush = _c === void 0 ? 'pre' : _c, onTrack = _b.onTrack, onTrigger = _b.onTrigger;
      if (!cb) {
      ...
      let warnInvalidSource = function (s) {
          warn$2("Invalid watch source: ".concat(s, ". A watch source can only be a getter/effect ") +
              "function, a ref, a reactive object, or an array of these types.");
      };
      let instance = currentInstance;
      let call = function (fn, type, args) {
      ...
      if (cb && deep) {
          let baseGetter_1 = getter;
          getter = function () { return traverse(baseGetter_1()); };
      }
      let cleanup;
      let onCleanup = function (fn) {
      ...
      let watcher = new Watcher(currentInstance, getter, noop, {
          lazy: true
      });
      ...
      if (flush === 'sync') {
          ...
          watcher.update = function () {
              if (instance && instance === currentInstance && !instance._isMounted) {
                  ...
                  let buffer = instance._preWatchers || (instance._preWatchers = []);
  ...
  let EffectScope = /** @class */ (function () {
  ...
  function resolveProvided(vm) {
      ...
      let existing = vm._provided;
      let parentProvides = vm.$parent && vm.$parent._provided;
  ...
  function inject(key, defaultValue, treatDefaultAsFactory) {
      ...
      if (instance) {
          ...
          let provides = instance.$parent && instance.$parent._provided;
  ...
  if (typeof Promise !== 'undefined' && isNative(Promise)) {
      ...
      let textNode_1 = document.createTextNode(String(counter_1));
  ...
  /**
   * Runtime helper for SFC's CSS letiable injection feature.
   * @private
   */
  function useCsslets(getter) {
      if (!inBrowser && !false)
          return;
      let instance = currentInstance;
      if (!instance) {
          warn$2("useCsslets is called without current active component instance.");
          return;
      }
      watchPostEffect(function () {
          let el = instance.$el;
          let lets = getter(instance, instance._setupProxy);
          if (el && el.nodeType === 1) {
              let style = el.style;
              for (let key in lets) {
                  style.setProperty("--".concat(key), lets[key]);
              }
          }
      });
  }
  ...
  function defineAsyncComponent(source) {
      ...
      let loader = source.loader, loadingComponent = source.loadingComponent, errorComponent = source.errorComponent, _a = source.delay, delay = _a === void 0 ? 200 : _a, timeout = source.timeout, // undefined = never times out
                  ...
                  loader()
                      ...
                      if (userOnError) {
                          return new Promise(function (resolve, reject) {
                              let userRetry = function () { return resolve(retry()); };
                              let userFail = function () { return reject(err); };
  ...
  let onBeforeMount = createLifeCycle('beforeMount');
  let onMounted = createLifeCycle('mounted');
  let onBeforeUpdate = createLifeCycle('beforeUpdate');
  let onUpdated = createLifeCycle('updated');
  let onBeforeUnmount = createLifeCycle('beforeDestroy');
  let onUnmounted = createLifeCycle('destroyed');
  let onActivated = createLifeCycle('activated');
  let onDeactivated = createLifeCycle('deactivated');
  let onServerPrefetch = createLifeCycle('serverPrefetch');
  let onRenderTracked = createLifeCycle('renderTracked');
  let onRenderTriggered = createLifeCycle('renderTriggered');
  let injectErrorCapturedHook = createLifeCycle('errorCaptured');
      ...
      Watcher.prototype.run = function () {
          if (this.active) {
              ...
              if (value !== this.value ||
                  ...
                  this.value = value;
                  if (this.user) {
                      let info = "callback for watcher \"".concat(this.expression, "\"");
  ...
  function initProps$1(vm, propsOptions) {
      ...
      let props = (vm._props = shallowReactive({}));
  ...
  function stateMixin(Vue) {
      ...
      Vue.prototype.$watch = function (expOrFn, cb, options) {
          ...
          if (options.immediate) {
              let info = "callback for immediate watcher \"".concat(watcher.expression, "\"");
              pushTarget();
  ...
  function initProvide(vm) {
      let provideOption = vm.$options.provide;
      if (provideOption) {
          let provided = isFunction(provideOption)
              ? provideOption.call(vm)
              : provideOption;
          if (!isObject(provided)) {
              return;
          }
          let source = resolveProvided(vm);
          // IE9 doesn't support Object.getOwnPropertyDescriptors so we have to
          // iterate the keys ourselves.
          let keys = hasSymbol ? Reflect.ownKeys(provided) : Object.keys(provided);
          for (let i = 0; i < keys.length; i++) {
              let key = keys[i];
  ...
  function FunctionalRenderContext(data, props, children, parent, Ctor) {
      ...
      if (options._scopeId) {
          this._c = function (a, b, c, d) {
              let vnode = createElement$1(contextVm, a, b, c, d, needNormalization);
  ...
  let componentVNodeHooks = {
      ...
      insert: function (vnode) {
          let context = vnode.context, componentInstance = vnode.componentInstance;
  ...
  {
      let hasConsole_1 = typeof console !== 'undefined';
      let classifyRE_1 = /(?:^|[-_])(\w)/g;
      let classify_1 = function (str) {
      ...
      formatComponentName = function (vm, includeFile) {
          ...
          let options = isFunction(vm) && vm.cid != null
              ? vm.options
              : vm._isVue
  ...
  function mergeDataOrFn(parentVal, childVal, vm) {
      if (!vm) {
          ...
          return function mergedInstanceDataFn() {
              // instance merge
              let instanceData = isFunction(childVal)
                  ? childVal.call(vm, vm)
                  : childVal;
              let defaultData = isFunction(parentVal)
  ...
  strats.watch = function (parentVal, childVal, vm, key) {
      ...
      for (let key_1 in childVal) {
          let parent_1 = ret[key_1];
          let child = childVal[key_1];
  ...
  function assertProp(prop, name, value, vm, absent) {
      ...
      let haveExpectedTypes = expectedTypes.some(function (t) { return t; });
  ...
  function initExtend(Vue) {
      ...
      Vue.extend = function (extendOptions) {
          ...
          let name = getComponentName(extendOptions) || getComponentName(Super.options);
          if (name) {
  ...
  function pruneCache(keepAliveInstance, filter) {
      let cache = keepAliveInstance.cache, keys = keepAliveInstance.keys, _vnode = keepAliveInstance._vnode;
      for (let key in cache) {
          let entry = cache[key];
          if (entry) {
              let name_1 = entry.name;
  ...
  let KeepAlive = {
      ...
      methods: {
          cacheVNode: function () {
              let _a = this, cache = _a.cache, keys = _a.keys, vnodeToCache = _a.vnodeToCache, keyToCache = _a.keyToCache;
              if (vnodeToCache) {
                  let tag = vnodeToCache.tag, componentInstance = vnodeToCache.componentInstance, componentOptions = vnodeToCache.componentOptions;
                  cache[keyToCache] = {
      ...
      render: function () {
          ...
          if (componentOptions) {
              // check pattern
              let name_2 = _getComponentName(componentOptions);
              let _a = this, include = _a.include, exclude = _a.exclude;
              if (
              // not included
              ...
              let _b = this, cache = _b.cache, keys = _b.keys;
  ...
  let isBooleanAttr = makeMap('allowfullscreen,async,autofocus,autoplay,checked,compact,controls,declare,' +
  ...
  let isHTMLTag = makeMap('http,body,base,head,link,meta,style,title,' +
  ...
  let isSVG = makeMap('svg,animate,circle,clippath,cursor,defs,desc,ellipse,filter,font-face,' +
  ...
  function registerRef(vnode, isRemoval) {
      let ref = vnode.data.ref;
      if (!isDef(ref))
          return;
      let vm = vnode.context;
      let refValue = vnode.componentInstance || vnode.elm;
      let value = isRemoval ? null : refValue;
      let $refsValue = isRemoval ? undefined : refValue;
      if (isFunction(ref)) {
          invokeWithErrorHandling(ref, vm, [value], vm, "template ref function");
          return;
      }
      let isFor = vnode.data.refInFor;
      let _isString = typeof ref === 'string' || typeof ref === 'number';
      let _isRef = isRef(ref);
      let refs = vm.$refs;
      if (_isString || _isRef) {
          if (isFor) {
              let existing = _isString ? refs[ref] : ref.value;
              if (isRemoval) {
  ...
  function setSetupRef(_a, key, val) {
      let _setupState = _a._setupState;
  ...
  function createPatchFunction(backend) {
      let i, j;
      let cbs = {};
      let modules = backend.modules, nodeOps = backend.nodeOps;
      ...
      function hydrate(elm, vnode, insertedVnodeQueue, inVPre) {
          let i;
          let tag = vnode.tag, data = vnode.data, children = vnode.children;
                  ...
                  if (isDef(vnode.parent)) {
                      ...
                      while (ancestor) {
                          ...
                          if (patchable) {
                              ...
                              let insert_1 = ancestor.data.hook.insert;
                              if (insert_1.merged) {
  ...
  function _update(oldVnode, vnode) {
      ...
      let oldDirs = normalizeDirectives(oldVnode.data.directives, oldVnode.context);
      let newDirs = normalizeDirectives(vnode.data.directives, vnode.context);
      let dirsWithInsert = [];
  ...
  function normalizeDirectives(dirs, vm) {
      ...
      for (i = 0; i < dirs.length; i++) {
          ...
          if (vm._setupState && vm._setupState.__sfc) {
              let setupDef = dir.def || resolveAsset(vm, '_setupState', 'v-' + dir.name);
  ...
  let baseModules = [ref, directives$1];
  ...
  function genComponentModel(el, value, modifiers) {
      let _a = modifiers || {}, number = _a.number, trim = _a.trim;
  ...
  function genCheckboxModel(el, value, modifiers) {
      ...
      addHandler(el, 'change', "let $$a=".concat(value, ",") +
          '$$el=$event.target,' +
          "$$c=$$el.checked?(".concat(trueValueBinding, "):(").concat(falseValueBinding, ");") +
          'if(Array.isArray($$a)){' +
          "let $$v=".concat(number ? '_n(' + valueBinding + ')' : valueBinding, ",") +
          '$$i=_i($$a,$$v);' +
  ...
  function genSelect(el, value, modifiers) {
      ...
      let code = "let $$selectedVal = ".concat(selectedVal, ";");
  ...
  function genDefaultModel(el, value, modifiers) {
      ...
      {
          let value_1 = el.attrsMap['v-bind:value'] || el.attrsMap[':value'];
      ...
      let _a = modifiers || {}, lazy = _a.lazy, number = _a.number, trim = _a.trim;
  ...
  function createOnceHandler(event, handler, capture) {
      let _target = target; // save current target element in closure
      return function onceHandler() {
  ...
  function add(name, handler, capture, passive) {
      ...
      if (useMicrotaskFix) {
          let attachedTimestamp_1 = currentFlushTimestamp;
          let original_1 = handler;
          //@ts-expect-error
  ...
  let normalize = cached(function (prop) {
      ...
      for (let i = 0; i < vendorNames.length; i++) {
          let name_1 = vendorNames[i] + capName;
  ...
  function whenTransitionEnds(el, expectedType, cb) {
      let _a = getTransitionInfo(el, expectedType), type = _a.type, timeout = _a.timeout, propCount = _a.propCount;
      if (!type)
          return cb();
  ...
  function enter(vnode, toggleDisplay) {
      ...
      let css = data.css, type = data.type, enterClass = data.enterClass, enterToClass = data.enterToClass, enterActiveClass = data.enterActiveClass, appearClass = data.appearClass, appearToClass = data.appearToClass, appearActiveClass = data.appearActiveClass, beforeEnter = data.beforeEnter, enter = data.enter, afterEnter = data.afterEnter, enterCancelled = data.enterCancelled, beforeAppear = data.beforeAppear, appear = data.appear, afterAppear = data.afterAppear, appearCancelled = data.appearCancelled, duration = data.duration;
      ...
      let enterHook = isAppear ? (isFunction(appear) ? appear : enter) : enter;
  ...
  function leave(vnode, rm) {
      ...
      let css = data.css, type = data.type, leaveClass = data.leaveClass, leaveToClass = data.leaveToClass, leaveActiveClass = data.leaveActiveClass, beforeLeave = data.beforeLeave, leave = data.leave, afterLeave = data.afterLeave, leaveCancelled = data.leaveCancelled, delayLeave = data.delayLeave, duration = data.duration;
      let expectsCSS = css !== false && !isIE9;
  ...
  let platformModules = [attrs, klass$1, events, domProps, style$1, transition];

  // the directive module should be applied last, after all
  // built-in modules have been applied.
  let modules$1 = platformModules.concat(baseModules);
  let patch = createPatchFunction({ nodeOps: nodeOps, modules: modules$1 });
  ...
  let directive = {
      ...
      componentUpdated: function (el, binding, vnode) {
          if (vnode.tag === 'select') {
              ...
              // option in the DOM.
              let prevOptions_1 = el._vOptions;
              let curOptions_1 = (el._vOptions = [].map.call(el.options, getValue));
  ...
  let show = {
      bind: function (el, _a, vnode) {
          ...
          let transition = vnode.data && vnode.data.transition;
      ...
      update: function (el, _a, vnode) {
          let value = _a.value, oldValue = _a.oldValue;
          /* istanbul ignore if */
          if (!value === !oldValue)
              return;
          vnode = locateNode(vnode);
  ...
  let Transition = {
      ...
      render: function (h) {
          ...
          // during entering.
          let id = "__transition-".concat(this._uid, "-");
          child.key =
              child.key == null
                  ? child.isComment
                      ? id + 'comment'
                  ...
                  : isPrimitive(child.key)
                      ? String(child.key).indexOf(id) === 0
                          ...
                          : id + child.key
                      : child.key;
          let data = ((child.data || (child.data = {})).transition =
  ...
  let TransitionGroup = {
      ...
      beforeMount: function () {
          ...
          this._update = function (vnode, hydrating) {
              let restoreActiveInstance = setActiveInstance(_this);
              // force removing pass
  ...
  let isUnaryTag = makeMap('area,base,br,col,embed,frame,hr,img,input,isindex,keygen,' +
  ...
  let isNonPhrasingTag = makeMap('address,article,aside,base,blockquote,body,caption,col,colgroup,dd,' +
  ...
  let ncname = "[a-zA-Z_][\\-\\.0-9_a-zA-Z".concat(unicodeRegExp.source, "]*");
  let qnameCapture = "((?:".concat(ncname, "\\:)?").concat(ncname, ")");
  let startTagOpen = new RegExp("^<".concat(qnameCapture));
  let startTagClose = /^\s*(\/?)>/;
  let endTag = new RegExp("^<\\/".concat(qnameCapture, "[^>]*>"));
  ...
  function parseHTML(html, options) {
      ...
      let _loop_1 = function () {
          ...
          if (!lastTag || !isPlainTextElement(lastTag)) {
              ...
              let stackedTag_1 = lastTag.toLowerCase();
              let reStackedTag = reCache[stackedTag_1] ||
          ...
          if (currentParent && !element.forbidden) {
              if (element.elseif || element.else) {
                  ...
                  if (element.slotScope) {
                      ...
                      let name_1 = element.slotTarget || '"default"';
      ...
      // 2.6 v-slot syntax
      {
          if (el.tag === 'template') {
              ...
              if (slotBinding) {
                  ...
                  let _a = getSlotName(slotBinding), name_2 = _a.name, dynamic = _a.dynamic;
              ...
              if (slotBinding) {
                  ...
                  let _b = getSlotName(slotBinding), name_3 = _b.name, dynamic = _b.dynamic;
                  let slotContainer_1 = (slots[name_3] = createASTElement('template', [], el));
  ...
  function preTransformNode(el, options) {
      if (el.tag === 'input') {
          ...
          if (typeBinding) {
              ...
              let ifConditionExtra = ifCondition ? "&&(".concat(ifCondition, ")") : "";
  ...
  let genGuard = function (condition) { return "if(".concat(condition, ")return null;"); };
  let modifierCode = {
  ...
  function genHandlers(events, isNative) {
      ...
      let staticHandlers = "";
      let dynamicHandlers = "";
      for (let name_1 in events) {
          let handlerCode = genHandler(events[name_1]);
          //@ts-expect-error
      ...
      if (!handler.modifiers) {
          ...
          let _loop_1 = function (key) {
              if (modifierCode[key]) {
                  ...
                  let modifiers_1 = handler.modifiers;
  ...
  let CodegenState = /** @class */ (function () {
  ...
  function genElement(el, state) {
      ...
      if (el.staticRoot && !el.staticProcessed) {
          ...
          if (el.component) {
              ...
              let data = void 0;
              let maybeComponent = state.maybeComponent(el);
              ...
              = void 0;
              // check if this is a component in <script setup>
              let bindings = state.options.bindings;
  ...
  function checkBindingType(bindings, key) {
      let camelName = camelize(key);
      let PascalName = capitalize(camelName);
      ...
      let fromConst = checkType("setup-const" /* BindingTypes.SETUP_CONST */) ||
          checkType("setup-reactive-const" /* BindingTypes.SETUP_REACTIVE_CONST */);
      if (fromConst) {
          return fromConst;
      }
      let fromMaybeRef = checkType("setup-let" /* BindingTypes.SETUP_LET */) ||
  ...
  function genFor(el, state, altGen, altHelper) {
      let exp = el.for;
      let alias = el.alias;
      let iterator1 = el.iterator1 ? ",".concat(el.iterator1) : '';
      let iterator2 = el.iterator2 ? ",".concat(el.iterator2) : '';
  ...
  function genScopedSlots(el, slots, state) {
      ...
      // disconnected due to the intermediate scope letiable)
      // #9438, #9506
      // TODO: this can be further optimized by properly analyzing in-scope bindings
      // and skip force updating ones that do not actually use scope letiables.
      if (!needsForceUpdate) {
  ...
  function genScopedSlot(el, state) {
      ...
      let fn = "function(".concat(slotScope, "){") +
  ...
  function genChildren(el, state, checkSkip, altGenElement, altGenNode) {
      ...
      if (children.length) {
          ...
          if (children.length === 1 &&
              ...
              el_1.tag !== 'template' &&
              el_1.tag !== 'slot') {
              let normalizationType_1 = checkSkip
  ...
  function checkNode(node, warn) {
      if (node.type === 1) {
          for (let name_1 in node.attrsMap) {
              if (dirRE.test(name_1)) {
                  let value = node.attrsMap[name_1];
                  if (value) {
                      let range = node.rawAttrsMap[name_1];
                      if (name_1 === 'v-for') {
  ...
  function checkIdentifier(ident, type, text, warn, range) {
      if (typeof ident === 'string') {
          try {
              new Function("let ".concat(ident, "=_"));
          }
          catch (e) {
          ...
          if (count >= start) {
              for (let j = i - range; j <= i + range || end > count; j++) {
                  ...
                  if (j === i) {
                      ...
                      let length_1 = end > count ? lineLength - pad : end - start;
                      res.push("   |  " + repeat(" ", pad) + repeat("^", length_1));
                  }
                  else if (j > i) {
                      if (end > count) {
                          let length_2 = Math.min(end - count, lineLength);
      ...
      return function createCompiler(baseOptions) {
          function compile(template, options) {
              ...
              if (options) {
                  if (options.outputSourceRange) {
                      // $flow-disable-line
                      let leadingSpaceLength_1 = template.match(/^\s*/)[0].length;
                      warn = function (msg, range, tip) {
                          let data = typeof msg === 'string' ? { msg: msg } : msg;
                          if (range) {
                              if (range.start != null) {
  ...
  let _a = createCompiler(baseOptions), compileToFunctions = _a.compileToFunctions;
  ...
  let shouldDecodeNewlinesForHref = inBrowser
  ...
  Vue.prototype.$mount = function (el, hydrating) {
      ...
      if (el === document.body || el === document.documentElement) {
          warn$2("Do not mount Vue to <http> or <body> - mount to normal elements instead.");
          return this;
      }
      ...
      if (!options.render) {
          ...
          if (template) {
              ...
              let _a = compileToFunctions(template, {
  ...
  function effect(fn, scheduler) {
      let watcher = new Watcher(currentInstance, fn, noop, {
          sync: true
      });
      if (scheduler) {
          watcher.update = function () {
